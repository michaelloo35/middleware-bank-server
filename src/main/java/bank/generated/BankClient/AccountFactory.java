...
{
    AccountPrx create(String firstName, String lastName, String pesel, double monthlyIncome, com.zeroc.Ice.Current current)
        throws NoIncomeException;

    static final String[] _iceIds =
    {
        "::BankClient::AccountFactory",
        "::Ice::Object"
    };
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        inS.endReadParams();
        AccountPrx ret = obj.create(iceP_firstName, iceP_lastName, iceP_pesel, iceP_monthlyIncome, current);
