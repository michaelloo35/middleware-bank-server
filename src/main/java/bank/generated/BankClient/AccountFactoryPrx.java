...
{
    default AccountPrx create(String firstName, String lastName, String pesel, double monthlyIncome)
        throws NoIncomeException
    {
        return create(firstName, lastName, pesel, monthlyIncome, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default AccountPrx create(String firstName, String lastName, String pesel, double monthlyIncome, java.util.Map<String, String> context)
        throws NoIncomeException
    {
        try
        {
            return _iceI_createAsync(firstName, lastName, pesel, monthlyIncome, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<AccountPrx> createAsync(String firstName, String lastName, String pesel, double monthlyIncome)
    {
        return _iceI_createAsync(firstName, lastName, pesel, monthlyIncome, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<AccountPrx> createAsync(String firstName, String lastName, String pesel, double monthlyIncome, java.util.Map<String, String> context)
    {
        return _iceI_createAsync(firstName, lastName, pesel, monthlyIncome, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<AccountPrx> _iceI_createAsync(String iceP_firstName, String iceP_lastName, String iceP_pesel, double iceP_monthlyIncome, java.util.Map<String, String> context, boolean sync)
    {
