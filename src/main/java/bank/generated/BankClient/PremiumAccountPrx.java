...
{
    default CreditInfo applyForCredit(double value, CurrencyType currency, Date from, Date to)
        throws DateRangeError,
               NotAuthrorizedException
    {
        return applyForCredit(value, currency, from, to, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default CreditInfo applyForCredit(double value, CurrencyType currency, Date from, Date to, java.util.Map<String, String> context)
        throws DateRangeError,
               NotAuthrorizedException
    {
        try
        {
            return _iceI_applyForCreditAsync(value, currency, from, to, context, true).waitForResponseOrUserEx();
        }
        catch(DateRangeError ex)
        {
            throw ex;
        }
    ...
    default java.util.concurrent.CompletableFuture<CreditInfo> applyForCreditAsync(double value, CurrencyType currency, Date from, Date to)
    {
        return _iceI_applyForCreditAsync(value, currency, from, to, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<CreditInfo> applyForCreditAsync(double value, CurrencyType currency, Date from, Date to, java.util.Map<String, String> context)
    {
        return _iceI_applyForCreditAsync(value, currency, from, to, context, false);
    }

    default com.zeroc.IceInternal.OutgoingAsync<CreditInfo> _iceI_applyForCreditAsync(double iceP_value, CurrencyType iceP_currency, Date iceP_from, Date iceP_to, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<CreditInfo> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "applyForCredit", null, sync, _iceE_applyForCredit);
