...
public interface AccountFactoryPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return _iceI_createAsync(firstName, lastName, pesel, monthlyIncome, balance, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<AccountPrx> createAsync(String firstName, String lastName, String pesel, double monthlyIncome, double balance, java.util.Map<String, String> context)
    {
        return _iceI_createAsync(firstName, lastName, pesel, monthlyIncome, balance, context, false);
    }
